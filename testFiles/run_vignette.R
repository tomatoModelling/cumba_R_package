...
weather<-cumba::tomatoFoggia$weather
mgt <- cumba::tomatoFoggia$management
irri <- cumba::tomatoFoggia$irrigation
prod <- cumba::tomatoFoggia$production
...
outputsScenario<-?cumba_scenario(weather,
                                par,
                                transplantingDOY=100,
                                waterStressLevel = 0.6,
                                minimumTurn=6,
                                fullOut=T)
